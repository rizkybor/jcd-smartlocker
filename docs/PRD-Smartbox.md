...
- **Kanvas kiosk acuan (desain awal design system)**: 8″ tablet, 800×1280 px portrait (atau 1280×800 landscape), ~189 ppi, satu kolom keputusan per layar. **Sudah diputuskan tidak dipakai apa adanya** — hardware final adalah layar **7″ IPS 1024×600 landscape** (§8.1, §12 poin 8), jadi canvas kiosk perlu dikalibrasi ulang ke resolusi ini (bukan 800×1280) sebelum kiosk UI mulai dibangun dari komponen di `docs/design_reference/`.
...
- Ukuran layar kiosk **sudah diputuskan** (7″ 1024×600 landscape, §12 poin 8) — pekerjaan yang tersisa adalah kalibrasi ulang canvas/breakpoint di design system, bukan menunggu keputusan lagi.
